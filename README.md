...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/throwaway-email` | `npm install @voxgig-sdk/throwaway-email` |
| Python | `voxgig-sdk-throwaway-email` | `pip install voxgig-sdk-throwaway-email` |
| PHP | `voxgig-sdk/throwaway-email` | `composer require voxgig-sdk/throwaway-email` |
| Golang | `github.com/voxgig-sdk/throwaway-email-sdk/go` | `go get github.com/voxgig-sdk/throwaway-email-sdk/go` |
| Ruby | `voxgig-sdk-throwaway-email` | `gem install voxgig-sdk-throwaway-email` |
| Lua | `voxgig-sdk-throwaway-email` | `luarocks install voxgig-sdk-throwaway-email` |
