...
The Golang SDK for the ThrowawayEmail API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/throwaway-email-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/throwaway-email-sdk=../path/to/github.com/voxgig-sdk/throwaway-email-sdk
```
...
```
github.com/voxgig-sdk/throwaway-email-sdk/
...
The root package (`github.com/voxgig-sdk/throwaway-email-sdk`) re-exports everything needed
