...
// instead of `sdk.NewThrowawayEmailSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ThrowawayEmailSDK  { return NewThrowawayEmailSDK(nil) }
func Test() *ThrowawayEmailSDK { return TestSDK(nil, nil) }
