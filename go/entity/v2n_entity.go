...
func NewV2nEntity(client *core.ThrowawayEmailSDK, entopts map[string]any) *V2nEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V2nEntity) GetName() string { return e.name }
...
func (e *V2nEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V2nEntity) Deleted() bool {
	return e.deleted
}


func (e *V2nEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV2nEntity(e.client, opts)
}

func (e *V2nEntity) Data(args ...any) any {
...
func (e *V2nEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V2n; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V2nEntity) DataTyped(data ...V2n) V2n {
	if len(data) > 0 {
		return typedFrom[V2n](e.Data(asMap(data[0])))
	}
	return typedFrom[V2n](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V2n (all fields
// optional at the wire level).
func (e *V2nEntity) MatchTyped(match ...V2n) V2n {
	if len(match) > 0 {
		return typedFrom[V2n](e.Match(asMap(match[0])))
	}
	return typedFrom[V2n](e.Match())
}
...
func (e *V2nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V2nEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V2nLoadMatch and returns an V2n. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V2nEntity) LoadTyped(reqmatch V2nLoadMatch, ctrl map[string]any) (V2n, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V2n{}, err
	}
	return typedFrom[V2n](res), nil
}



func (e *V2nEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *V2nEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V2nEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V2nEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V2nEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
