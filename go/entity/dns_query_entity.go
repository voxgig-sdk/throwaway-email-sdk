...
func NewDnsQueryEntity(client *core.ThrowawayEmailSDK, entopts map[string]any) *DnsQueryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DnsQueryEntity) GetName() string { return e.name }
...
func (e *DnsQueryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DnsQueryEntity) Deleted() bool {
	return e.deleted
}


func (e *DnsQueryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDnsQueryEntity(e.client, opts)
}

func (e *DnsQueryEntity) Data(args ...any) any {
...
func (e *DnsQueryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DnsQueryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DnsQueryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DnsQueryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *DnsQueryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DnsQueryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DnsQueryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
