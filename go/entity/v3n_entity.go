...
func NewV3nEntity(client *core.ThrowawayEmailSDK, entopts map[string]any) *V3nEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *V3nEntity) GetName() string { return e.name }
...
func (e *V3nEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *V3nEntity) Deleted() bool {
	return e.deleted
}


func (e *V3nEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewV3nEntity(e.client, opts)
}

func (e *V3nEntity) Data(args ...any) any {
...
func (e *V3nEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an V3n; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *V3nEntity) DataTyped(data ...V3n) V3n {
	if len(data) > 0 {
		return typedFrom[V3n](e.Data(asMap(data[0])))
	}
	return typedFrom[V3n](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through V3n (all fields
// optional at the wire level).
func (e *V3nEntity) MatchTyped(match ...V3n) V3n {
	if len(match) > 0 {
		return typedFrom[V3n](e.Match(asMap(match[0])))
	}
	return typedFrom[V3n](e.Match())
}
...
func (e *V3nEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *V3nEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// V3nLoadMatch and returns an V3n. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *V3nEntity) LoadTyped(reqmatch V3nLoadMatch, ctrl map[string]any) (V3n, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return V3n{}, err
	}
	return typedFrom[V3n](res), nil
}



func (e *V3nEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *V3nEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *V3nEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *V3nEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *V3nEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
