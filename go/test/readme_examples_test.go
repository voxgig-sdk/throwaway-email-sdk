...
const testSeed = `map[string]any{"entity": map[string]any{"dns_query": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "email": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "resolve": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v2n": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "v3n": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
