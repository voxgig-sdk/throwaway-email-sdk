...
func TestListEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set THROWAWAYEMAIL_TEST_LIST_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func listBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("THROWAWAYEMAIL_TEST_LIST_ENTID")
