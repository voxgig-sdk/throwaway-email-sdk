...
func registerSDKWords(r *eng.Registry, client *sdk.ThrowawayEmailSDK) {
...
func runOp(client *sdk.ThrowawayEmailSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
