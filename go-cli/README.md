...
AQL-driven CLI and REPL for the ThrowawayEmail SDK. Positional arguments are
...
```sh
go build -o throwaway-email-cli ./...
```
...
./throwaway-email-cli list dns_query
./throwaway-email-cli load 1 dns_query
./throwaway-email-cli load '{id:1}' dns_query
