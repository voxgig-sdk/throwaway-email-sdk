...
class DnsQueryDirectTest extends TestCase
{
    public function test_direct_load_dns_query(): void
    {
        $setup = dns_query_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-dns_query", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
