...
class V2nDirectTest extends TestCase
{
    public function test_direct_load_v2n(): void
    {
        $setup = v2n_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-v2n", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
