...
class V3nEntityTest extends TestCase
{
    public function test_create_instance(): void
    {
        $testsdk = ThrowawayEmailSDK::test(null, null);
        $ent = $testsdk->V3n(null);
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set THROWAWAY_EMAIL_TEST_V3N_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function v3n_basic_setup($extra)
{
    ...
    $entity_data_file = __DIR__ . '/../../.sdk/test/entity/v3n/V3nTestData.json';
    ...
    $entid_env_raw = getenv("THROWAWAY_EMAIL_TEST_V3N_ENTID");
