...
// ThrowawayEmail SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ThrowawayEmailSDK::test)
...
{
    private const SDK_CLASS = 'ThrowawayEmailSDK';
    ...
    private const SDK_BASE = 'throwawayemail_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../throwawayemail_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
