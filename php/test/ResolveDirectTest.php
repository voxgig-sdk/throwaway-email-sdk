...
class ResolveDirectTest extends TestCase
{
    public function test_direct_load_resolve(): void
    {
        $setup = resolve_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-resolve", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
