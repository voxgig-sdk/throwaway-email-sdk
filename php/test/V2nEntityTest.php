...
class V2nEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set THROWAWAYEMAIL_TEST_V_N_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function v2n_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("THROWAWAYEMAIL_TEST_V_N_ENTID");
