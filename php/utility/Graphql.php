...
// ThrowawayEmail SDK utility: graphql
//
...
class ThrowawayEmailGraphql
{
    ...
    // equivalent.
    public static function body(ThrowawayEmailContext $ctx): mixed
    {
    ...
    public static function errors(ThrowawayEmailContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
