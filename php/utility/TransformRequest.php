...
// ThrowawayEmail SDK utility: transform_request

require_once __DIR__ . '/../core/Helpers.php';

class ThrowawayEmailTransformRequest
{
    public static function call(ThrowawayEmailContext $ctx): mixed
    {
        ...
        $transform = ThrowawayEmailHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return $ctx->reqdata;
        }
