...
class V3nEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new V3nEntity($this->_client, $opts);
    }

    /**
     * @param V3n|array $args V3n data (assoc-array) to store.
     */
    ...
    /**
     * @return V3n|array The current V3n data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V3n fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V3n fields).
     */
     ...
     * Load a single V3n.
     *
     * @param V3nLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V3nLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V3n|array The loaded V3n as an assoc-array at the
