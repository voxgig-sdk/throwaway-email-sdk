...
class V2nEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new V2nEntity($this->_client, $opts);
    }

    /**
     * @param V2n|array $args V2n data (assoc-array) to store.
     */
    ...
    /**
     * @return V2n|array The current V2n data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of V2n fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of V2n fields).
     */
     ...
     * Load a single V2n.
     *
     * @param V2nLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed V2nLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return V2n|array The loaded V2n as an assoc-array at the
