...
// ThrowawayEmail SDK telemetry feature
...
class ThrowawayEmailTelemetryFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _close(ThrowawayEmailContext $ctx, bool $ok): void
    {
