...
// ThrowawayEmail SDK timeout feature
...
class ThrowawayEmailTimeoutFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _with_timeout(ThrowawayEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ThrowawayEmailContext $_ctx, float $ms): void
    {
        $client = $this->client;
