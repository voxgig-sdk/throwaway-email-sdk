...
// ThrowawayEmail SDK debug feature
...
class ThrowawayEmailDebugFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _finish(ThrowawayEmailContext $ctx, bool $ok): void
    {
