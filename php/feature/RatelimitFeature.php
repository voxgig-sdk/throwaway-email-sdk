...
// ThrowawayEmail SDK ratelimit feature
...
class ThrowawayEmailRatelimitFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _acquire(ThrowawayEmailContext $ctx): void
    {
    ...
    private function _track(ThrowawayEmailContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
