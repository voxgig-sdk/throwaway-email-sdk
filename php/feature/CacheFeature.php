...
// ThrowawayEmail SDK cache feature
...
class ThrowawayEmailCacheFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _through(ThrowawayEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
