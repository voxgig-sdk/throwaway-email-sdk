...
// ThrowawayEmail SDK netsim feature
...
class ThrowawayEmailNetsimFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _simulate(ThrowawayEmailContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ThrowawayEmailContext $ctx, array $applied): void
    {
        $client = $this->client;
