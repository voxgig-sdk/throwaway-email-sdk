...
-- by passing it.
function ThrowawayEmailSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function ThrowawayEmailSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "ThrowawayEmailSDK: graphql: " .. msg
    res.graphql = errors
  end
