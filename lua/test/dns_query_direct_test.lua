...
describe("DnsQueryDirect", function()
  it("should direct-load-dns_query", function()
    local setup = dns_query_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dns_query", setup.live and "live" or "unit")
...
function dns_query_direct_setup(mockres)
