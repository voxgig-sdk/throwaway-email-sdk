...
function runner.env_override(m)
  local live = runner.getenv("THROWAWAY_EMAIL_TEST_LIVE")
  local override = runner.getenv("THROWAWAY_EMAIL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("THROWAWAY_EMAIL_TEST_EXPLAIN")
