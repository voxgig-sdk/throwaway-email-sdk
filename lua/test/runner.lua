...
function runner.env_override(m)
  local live = runner.getenv("THROWAWAYEMAIL_TEST_LIVE")
  local override = runner.getenv("THROWAWAYEMAIL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("THROWAWAYEMAIL_TEST_EXPLAIN")
