...
describe("V3nDirect", function()
  it("should direct-load-v3n", function()
    local setup = v3n_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-v3n", setup.live and "live" or "unit")
...
function v3n_direct_setup(mockres)
