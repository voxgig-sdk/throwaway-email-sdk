...
describe("V3nEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set THROWAWAY_EMAIL_TEST_V3N_ENTID JSON to run live")
      return
    end
    ...
    local v3n_ref01_match_dt0 = {}
    local v3n_ref01_data_dt0_loaded, err = v3n_ref01_ent:load(v3n_ref01_match_dt0, nil)
    assert.is_nil(err)
    assert.is_not_nil(v3n_ref01_data_dt0_loaded)
...
function v3n_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("THROWAWAY_EMAIL_TEST_V3N_ENTID")
