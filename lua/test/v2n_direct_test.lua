...
describe("V2nDirect", function()
  it("should direct-load-v2n", function()
    local setup = v2n_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-v2n", setup.live and "live" or "unit")
...
function v2n_direct_setup(mockres)
