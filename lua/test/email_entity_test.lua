...
describe("EmailEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set THROWAWAYEMAIL_TEST_EMAIL_ENTID JSON to run live")
      return
    end
...
function email_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("THROWAWAYEMAIL_TEST_EMAIL_ENTID")
