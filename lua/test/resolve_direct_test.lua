...
describe("ResolveDirect", function()
  it("should direct-load-resolve", function()
    local setup = resolve_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-resolve", setup.live and "live" or "unit")
...
function resolve_direct_setup(mockres)
