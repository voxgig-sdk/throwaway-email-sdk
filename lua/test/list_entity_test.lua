...
describe("ListEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set THROWAWAY_EMAIL_TEST_LIST_ENTID JSON to run live")
      return
    end
...
function list_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("THROWAWAY_EMAIL_TEST_LIST_ENTID")
