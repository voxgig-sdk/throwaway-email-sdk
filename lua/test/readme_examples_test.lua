...
local SDK_MODULE = "throwaway-email_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["dns_query"] = { ["test01"] = { id = "test01" } }, ["domain"] = { ["test01"] = { id = "test01" } }, ["email"] = { ["test01"] = { id = "test01" } }, ["list"] = { ["test01"] = { id = "test01" } }, ["resolve"] = { ["test01"] = { id = "test01" } }, ["v2n"] = { ["test01"] = { id = "test01" } }, ["v3n"] = { ["test01"] = { id = "test01" } } } }'
