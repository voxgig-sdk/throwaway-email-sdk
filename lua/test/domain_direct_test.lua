...
describe("DomainDirect", function()
  it("should direct-load-domain", function()
    local setup = domain_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-domain", setup.live and "live" or "unit")
