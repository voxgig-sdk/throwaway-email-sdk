...
describe('exists', async () => {
  ...
  //
  // ThrowawayEmailSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof ThrowawayEmailSDK, true,
      'ThrowawayEmailSDK.test() must return a client synchronously')
  })
