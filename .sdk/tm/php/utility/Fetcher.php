...
// ThrowawayEmail SDK utility: fetcher

class ThrowawayEmailFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ThrowawayEmailSDK/1.0)';
    ...
    public static function call(ThrowawayEmailContext $ctx, string $fullurl, array $fetchdef): array
    {
