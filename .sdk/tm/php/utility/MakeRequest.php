...
// ThrowawayEmail SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ThrowawayEmailMakeRequest
{
    public static function call(ThrowawayEmailContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ThrowawayEmailResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ThrowawayEmailResponse($fetched);
        } else {
