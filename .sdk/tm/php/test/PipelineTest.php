...
// ThrowawayEmail SDK pipeline test
//
...
{
    private static function utility(): ThrowawayEmailUtility
    {
        return new ThrowawayEmailUtility();
    }
    ...
    private static function ctx(array $over = []): ThrowawayEmailContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ThrowawayEmailContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ThrowawayEmailOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ThrowawayEmailError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ThrowawayEmailOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ThrowawayEmailMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ThrowawayEmailOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ThrowawayEmailMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ThrowawayEmailOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ThrowawayEmailMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ThrowawayEmailSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ThrowawayEmailMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ThrowawayEmailResponse([]),
            'result' => new ThrowawayEmailResult([]),
        ]);
        [, $err] = ThrowawayEmailMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ThrowawayEmailSpec([]),
            'response' => null,
            'result' => new ThrowawayEmailResult([]),
        ]);
        [, $err] = ThrowawayEmailMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ThrowawayEmailSpec(['step' => 's']),
            'response' => new ThrowawayEmailResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ThrowawayEmailResult([]),
        ]);
        [, $err] = ThrowawayEmailMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ThrowawayEmailSpec(['step' => 's']),
            'response' => new ThrowawayEmailResponse(self::resp(200, ['v' => 1])),
            'result' => new ThrowawayEmailResult([]),
        ]);
        [, $err] = ThrowawayEmailMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ThrowawayEmailSpec(['step' => 's']),
            'response' => new ThrowawayEmailResponse(self::resp(200, ['v' => 2])),
            'result' => new ThrowawayEmailResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ThrowawayEmailMakeResponse::call($ctx);
    ...
    {
        $preset = new ThrowawayEmailResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ThrowawayEmailSpec([]),
            'response' => new ThrowawayEmailResponse([]),
            'result' => new ThrowawayEmailResult([]),
        ...
        [$got, $err] = ThrowawayEmailMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ThrowawayEmailResult([])]);
        [, $err] = ThrowawayEmailMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ThrowawayEmailSpec([]), 'result' => null]);
        [, $err] = ThrowawayEmailMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ThrowawayEmailSpec(['step' => 's']),
            'result' => new ThrowawayEmailResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ThrowawayEmailOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ThrowawayEmailMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ThrowawayEmailSpec(['step' => 's']),
            'result' => new ThrowawayEmailResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ThrowawayEmailOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ThrowawayEmailMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ThrowawayEmailResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ThrowawayEmailSpec([]),
            'result' => new ThrowawayEmailResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ThrowawayEmailMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ThrowawayEmailMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ThrowawayEmailError('boom', 'boom');
        $utility->fetcher = function (ThrowawayEmailContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ThrowawayEmailSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ThrowawayEmailMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ThrowawayEmailContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ThrowawayEmailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ThrowawayEmailResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ThrowawayEmailMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ThrowawayEmailContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ThrowawayEmailSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ThrowawayEmailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ThrowawayEmailResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ThrowawayEmailSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ThrowawayEmailMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ThrowawayEmailMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ThrowawayEmailMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ThrowawayEmailResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ThrowawayEmailDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ThrowawayEmailResult(['ok' => false])]);
        $this->expectException(ThrowawayEmailError::class);
        ThrowawayEmailDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ThrowawayEmailResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ThrowawayEmailMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ThrowawayEmailMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ThrowawayEmailBaseFeature();
        $b = new ThrowawayEmailBaseFeature();
        ThrowawayEmailFeatureAdd::call($ctx, $a);
        ThrowawayEmailFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ThrowawayEmailBaseFeature
    {
        $f = new ThrowawayEmailBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ThrowawayEmailFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ThrowawayEmailContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ThrowawayEmailSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ThrowawayEmailPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ThrowawayEmailPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ThrowawayEmailResponse(['headers' => null]),
            'result' => new ThrowawayEmailResult([]),
        ]);
        ThrowawayEmailResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ThrowawayEmailResultBody::call($ctx);
