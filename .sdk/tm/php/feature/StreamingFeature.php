...
// ThrowawayEmail SDK streaming feature
...
class ThrowawayEmailStreamingFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _iterate(ThrowawayEmailResult $result): \Generator
    {
    ...
    private function _streamable(ThrowawayEmailContext $ctx): bool
    {
