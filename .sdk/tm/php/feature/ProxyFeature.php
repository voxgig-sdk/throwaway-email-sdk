...
// ThrowawayEmail SDK proxy feature
...
class ThrowawayEmailProxyFeature extends ThrowawayEmailBaseFeature
{
    ...
    public function init(ThrowawayEmailContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ThrowawayEmailContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
