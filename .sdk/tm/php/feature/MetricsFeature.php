...
// ThrowawayEmail SDK metrics feature
...
class ThrowawayEmailMetricsFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _record(ThrowawayEmailContext $ctx, bool $ok): void
    {
