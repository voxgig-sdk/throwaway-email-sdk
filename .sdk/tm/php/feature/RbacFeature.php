...
// ThrowawayEmail SDK rbac feature
...
class ThrowawayEmailRbacFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _required(ThrowawayEmailContext $ctx): ?string
    {
    ...
    private function _reject(ThrowawayEmailContext $ctx, string $required): void
    {
    ...
    private function _track(ThrowawayEmailContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
