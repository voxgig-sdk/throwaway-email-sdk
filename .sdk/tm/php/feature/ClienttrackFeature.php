...
// ThrowawayEmail SDK clienttrack feature
...
class ThrowawayEmailClienttrackFeature extends ThrowawayEmailBaseFeature
{
    ...
    public function PostConstruct(ThrowawayEmailContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ThrowawayEmail-SDK';
