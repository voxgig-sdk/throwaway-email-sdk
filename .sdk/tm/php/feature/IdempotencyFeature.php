...
// ThrowawayEmail SDK idempotency feature
...
class ThrowawayEmailIdempotencyFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _mutating(ThrowawayEmailContext $ctx): bool
    {
