...
// ThrowawayEmail SDK audit feature
...
class ThrowawayEmailAuditFeature extends ThrowawayEmailBaseFeature
{
    ...
    private function _emit(ThrowawayEmailContext $ctx, string $outcome): void
    {
