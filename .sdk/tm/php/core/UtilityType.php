...
// ThrowawayEmail SDK utility type

class ThrowawayEmailUtility
{
    ...
    public static function copy(ThrowawayEmailUtility $src): ThrowawayEmailUtility
    {
        $u = new ThrowawayEmailUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
