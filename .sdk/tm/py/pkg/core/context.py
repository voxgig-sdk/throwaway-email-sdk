...
from projectname_sdk.core.control import ThrowawayEmailControl
...
class ThrowawayEmailContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ThrowawayEmailControl()
        ...
        if isinstance(sp, ThrowawayEmailSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ThrowawayEmailResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ThrowawayEmailResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ThrowawayEmailOperation({})
    ...
    def make_error(self, code, msg):
        return ThrowawayEmailError(code, msg, self)
