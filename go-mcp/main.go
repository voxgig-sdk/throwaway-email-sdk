// Command ThrowawayEmail-mcp is an MCP server exposing the ThrowawayEmail
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ThrowawayEmail_list  — list records of an entity
//	ThrowawayEmail_load  — load a single record of an entity
//
