...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dns_query | domain | email | list | resolve | v2n | v3n"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ThrowawayEmailSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "throwaway-email_list",
		Description: "List records from ThrowawayEmail. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "throwaway-email_load",
		Description: "Load a single record from ThrowawayEmail. " +
...
func runOp(client *sdk.ThrowawayEmailSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ThrowawayEmailSDK, name string) (sdk.ThrowawayEmailEntity, error) {
	switch strings.ToLower(name) {
	case "dns_query":
		return client.DnsQuery(nil), nil
	case "domain":
	...
	case "resolve":
		return client.Resolve(nil), nil
	case "v2n":
		return client.V2n(nil), nil
	case "v3n":
