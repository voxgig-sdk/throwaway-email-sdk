// ThrowawayEmail Ts SDK

import { DnsQueryEntity } from './entity/DnsQueryEntity'
...
class ThrowawayEmailSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new ThrowawayEmailSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return ThrowawayEmailSDK.test(testopts, sdkopts)
  }


  toJSON() {
    return { name: 'ThrowawayEmail' }
  }

  toString() {
    return 'ThrowawayEmail ' + this._utility.struct.jsonify(this.toJSON())
  }
