...
describe('DnsQueryDirect', async () => {
  ...
  test('direct-load-dns_query', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-dns_query', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['THROWAWAY_EMAIL_TEST_DNS_QUERY_ENTID']
