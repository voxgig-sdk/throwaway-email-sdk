...
#      offline in seeded test mode (ThrowawayEmailSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ThrowawayEmail_sdk.rb")
  SDK_CLASS = "ThrowawayEmailSDK"
