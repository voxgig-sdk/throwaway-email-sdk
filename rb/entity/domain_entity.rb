# ThrowawayEmail SDK Domain entity
...
class DomainEntity
  ...
  #
  # @param reqmatch [DomainLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Domain.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Domain, Hash] the loaded Domain; raises ThrowawayEmailError on failure
