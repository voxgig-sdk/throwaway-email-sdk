# ThrowawayEmail SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ThrowawayEmailSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ThrowawayEmailSDK(...) and ThrowawayEmailSDK.test(...) become
#      ThrowawayEmailSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "throwawayemail_sdk"
_SDK_CLASS = "ThrowawayEmailSDK"
