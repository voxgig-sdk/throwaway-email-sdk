...
class ThrowawayEmailTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ThrowawayEmailTestRunner.getenv("THROWAWAYEMAIL_TEST_LIVE")
        override = ThrowawayEmailTestRunner.getenv("THROWAWAYEMAIL_TEST_OVERRIDE")
        ...
        explain = ThrowawayEmailTestRunner.getenv("THROWAWAYEMAIL_TEST_EXPLAIN")
