...
from throwawayemail_sdk.utility import register

# Load features
from throwawayemail_sdk.feature.base_feature import ThrowawayEmailBaseFeature
from throwawayemail_sdk.features import _has_feature, _make_feature
...
class ThrowawayEmailSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ThrowawayEmailSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DnsQuery(self, data=None) -> "DnsQueryEntity":
        ...
        from throwawayemail_sdk.entity.dns_query_entity import DnsQueryEntity
